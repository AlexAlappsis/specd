...
> _New to the spec system? If you haven't already in this conversation, see [spec/agent-guide.md](../spec/agent-guide.md) for a quick reference to the four-tier structure and how tasks fit into the execution planning workflow._
