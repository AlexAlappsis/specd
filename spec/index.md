...
| Templates Manifest              | `spec/spec-manifest.md`        |
...
4. For template discovery and automation setup, open `spec/spec-manifest.md`.

---

> *Agent note:*
> This index is meant for navigation and document discovery. Use it to determine which file paths to load int
