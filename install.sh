...
echo ""
echo "Next steps:"
echo "1. Run: /spec-plan"
echo "   This will guide you through planning your system charter, architecture, and implementation"
echo "   It will initialize tiers as needed by creating working files from templates"
echo ""
echo "2. Create specific items:"
